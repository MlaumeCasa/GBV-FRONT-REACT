...
export default function ReportIncident({ navigation }) {
  ...
  const handleSubmit = () => {
    if (!query || !description) {
      Alert.alert("Missing Fields", "Please fill in both location and description.");
      return;
    }

    console.log({ query, description, anonymous, media });
    ...
    <View style={styles.container}>
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
          <MaterialCommunityIcons name="file-upload-outline" size={22} color="#8a2be2" />
        ...
        {media && (
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 8 }}>
            <MaterialCommunityIcons name="file-check-outline" size={18} color="#8a2be2" />
      ...
      <View style={styles.toggleContainer}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Feather name="user-x" size={18} color="#8a2be2" style={{ marginRight: 6 }} />
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 26, fontWeight: "700", color: "#8a2be2", marginBottom: 25 },
  labelRow: {
    flexDirection: "row",
    alignItems: "center",
    marginBottom: 6,
